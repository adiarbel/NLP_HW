...
for threshold in thresholds:
    ...
    weights_path_load = "train1_weights_extra_features/newlam2_trained_weights_th{}_ep{}.pkl".format(threshold, num_iterations)
    ...
    train_helper.train(path, threshold, num_iterations, weights_path_load,"times/newlam2")
    '''
